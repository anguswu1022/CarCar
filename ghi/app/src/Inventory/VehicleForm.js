    ...
    return (
        <div className="row">
            ...
            <div className="shadow p-4 mt-4">
                ...
                <div className="form-floating mb-3">
                    <input onChange={e => setPictureUrl(e.target.value)} value={picture_url} placeholder="Picture URL" required type="url" name="pictureUrl" id="pictureUrl" className="form-control" />
                    <label htmlFor="modelName">Picture URL</label>
                </div>
                <div className="mb-3">
                    <select onChange={e => setManufacturer(e.target.value)} required id="manufacturer" name="manufacturer" className="form-select" value={manufacturer}>
